...
<div class="container mx-auto px-4">
    <div class="p-2 max-w-md mx-auto my-10 bg-white p-5 rounded-lg shadow-lg">
        <h2 class="text-2xl font-semibold mb-5">Edit Subcategory</h2>
        <form method="POST" action="{{ route('subcategories.update', $subcategory->id) }}" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" id="name" value="{{ old('name', $subcategory->name) }}" class="border rounded-lg px-3 py-2 w-full focus:outline-none focus:ring focus:border-blue-300" required>
                @error('name')
            ...
            <div class="mt-8">
                <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition duration-200">Update Subcategory</button>
            </div>
        </form>
    </div>
</div>
